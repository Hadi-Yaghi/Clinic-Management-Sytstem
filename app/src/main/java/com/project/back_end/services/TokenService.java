...
public class TokenService {
    private String secretKey="$!@#$^%$$$%####$DDCPN0234FCFDPD8670M";
...
public TokenService(DoctorRepository doctorRepository,
...
private SecretKey getSignKey() {
    byte[] keyBytes = "$!@#$^%$$$%####$DDCPN0234FCFDPD8670M".getBytes(StandardCharsets.UTF_8);
...
public String extractIdentifier(String token) {
    try {
        ...
        return claims.getSubject(); // this is the identifier (email/username)
...
public boolean validateToken(String token, String userType) {
        try {
            ...
            String identifier = claims.getSubject(); // email OR username
            ...
            switch (userType.toLowerCase()) {
                ...
                case "admin":
                    return adminRepository.findAdminByUsername(identifier) != null;
